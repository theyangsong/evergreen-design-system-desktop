...
export function useDataListPagePreview(
  ...
  const batchButton = computed(() => {
    ...
    return readIconButtonProSingleItem(customize.value, 'batch');
  });

  const filterButton = computed(() => {
    trackSingleIconButton('filter');
    return readIconButtonProSingleItem(customize.value, 'filter');
  });

  const refreshButton = computed(() => {
    trackSingleIconButton('refresh');
    return readIconButtonProSingleItem(customize.value, 'refresh');
  });

  const exportButton = computed(() => {
    trackSingleIconButton('export');
    return readIconButtonProSingleItem(customize.value, 'export');
  });
